  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          CustomText(text: title, fontSize: titleFontSize ?? 15.sp),
          ...
          Row(
            children: [
              ...
              SizedBox(width: 10.w),
              CustomText(text: statusLabel, fontSize: labelFontSize ?? 13.sp),
              CustomText(text: statusValue, fontSize: valueFontSize ?? 15.sp),
            ],
          ),
        ],
      ),
